...
export async function renderSettings(guildId, readOnly = false) {
  ...
  const row5 = new ActionRowBuilder().addComponents(
    ...
    new ButtonBuilder().setCustomId('post_test').setLabel('Test Deal').setStyle(ButtonStyle.Primary).setDisabled(readOnly),
    new ButtonBuilder().setCustomId('reset_settings').setLabel('Reset').setStyle(ButtonStyle.Danger).setDisabled(readOnly),
  );
